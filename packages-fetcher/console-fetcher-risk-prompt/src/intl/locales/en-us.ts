...
To protect your account, set a verification method correctly.`,
  ...
  'title:default': 'Security Verification',
  'title:sub_vmfa_auth': 'Auth Virtual MFA Device',
  'title:sub_u2f_auth': 'Auth U2F Security Key',
  'title:sms_auth': 'Verify Phone',
  'title:email_auth': 'Verify Email',
  ...
  'message:get_u2f_key_params_error': 'The parameter to get the U2F security key is wrong.',
  ...
  'message:u2f_get_key': 'Waiting for the U2F security key...',
  'message:u2f_get_key_success': 'The U2F security key is obtained.',
