...
export { default as useRefTabBar } from './use-dispatch-set-dom-tab-bar';
export { default as useRefTabList } from './use-dispatch-set-dom-tab-list';
export { default as useRefExtra } from './use-dispatch-set-dom-extra';
...
// handlers
export { default as useHandleTabBarDoubleClick } from './use-handle-tab-bar-double-click';
