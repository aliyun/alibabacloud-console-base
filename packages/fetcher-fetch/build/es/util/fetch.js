...
export default function (url) {
  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
      ...
      fetchOptions = _objectWithoutProperties(_ref, ["timeout"]);
  ...
  var promise = fetch(url, fetchOptions).catch(function (err) {
    ...
    throw createError(EFetchError.NETWORK, err === null || err === void 0 ? void 0 : err.message);
  });
  return timeout > 0 ? new Promise(function (resolve, reject) {
    var theTimer = setTimeout(function () {
      reject(createError(EFetchError.TIMEOUT, "fetch('".concat(url, "') timeout after ").concat(timeout, "ms")));
    }, timeout);
