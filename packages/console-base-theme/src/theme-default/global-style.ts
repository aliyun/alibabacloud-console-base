...
export default createGlobalStyle`
  :root {
    ...
    --cb-color-button-menu-active-text: ${COLOR.BUTTON_MENU_ACTIVE_TEXT};
    --cb-color-button-menu-active-bg: ${COLOR.BUTTON_MENU_ACTIVE_BG};
    --cb-color-button-menu-active-border: ${COLOR.BUTTON_MENU_ACTIVE_BORDER};
    --cb-color-button-menu-active-text-hover: ${COLOR.BUTTON_MENU_ACTIVE_TEXT_HOVER};
    --cb-color-button-menu-active-bg-hover: ${COLOR.BUTTON_MENU_ACTIVE_BG_HOVER};
    --cb-color-button-menu-active-border-hover: ${COLOR.BUTTON_MENU_ACTIVE_BORDER_HOVER};
    --cb-color-button-menu-active-text-active: ${COLOR.BUTTON_MENU_ACTIVE_TEXT_ACTIVE};
    --cb-color-button-menu-active-bg-active: ${COLOR.BUTTON_MENU_ACTIVE_BG_ACTIVE};
    --cb-color-button-menu-active-border-active: ${COLOR.BUTTON_MENU_ACTIVE_BORDER_ACTIVE};
    --cb-color-button-menu-active-text-disabled: ${COLOR.BUTTON_MENU_ACTIVE_TEXT_DISABLED};
    --cb-color-button-menu-active-bg-disabled: ${COLOR.BUTTON_MENU_ACTIVE_BG_DISABLED};
    --cb-color-button-menu-active-border-disabled: ${COLOR.BUTTON_MENU_ACTIVE_BORDER_DISABLED};
