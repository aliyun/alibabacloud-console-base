...
export default function createThemeGlobalStyle({
  ...
  return createGlobalStyle`
    :root {
      ...
      --cb-color-bg-help-fade: ${COLOR.BG_HELP_FADE};
      --cb-color-bg-info: ${COLOR.BG_INFO};
      --cb-color-bg-info-fade: ${COLOR.BG_INFO_FADE};
      --cb-color-bg-success: ${COLOR.BG_SUCCESS};
      --cb-color-bg-success-fade: ${COLOR.BG_SUCCESS_FADE};
      --cb-color-bg-warning: ${COLOR.BG_WARNING};
      --cb-color-bg-warning-fade: ${COLOR.BG_WARNING_FADE};
      --cb-color-bg-error: ${COLOR.BG_ERROR};
      --cb-color-bg-error-fade: ${COLOR.BG_ERROR_FADE};
