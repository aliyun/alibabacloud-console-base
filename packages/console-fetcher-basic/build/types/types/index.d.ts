import { Fetcher, FetcherConfig, FetcherOptionsForQuickPost } from '@alicloud/fetcher';
import { FetcherConfigExtraSecurity } from '@alicloud/console-fetcher-interceptor-req-security';
import { FetcherConfigExtraBiz } from '@alicloud/console-fetcher-interceptor-res-biz';
import { ConsoleFetcherInterceptorArmsConfig } from '@alicloud/console-fetcher-interceptor-arms';
import { ConsoleFetcherInterceptorSlsConfig } from '@alicloud/console-fetcher-interceptor-sls';
export declare type TApiMultiResult = Record<string, unknown>;
/**
