...
export default {
  ...
  regionRefreshResourceCount: regionRefreshResourceCount,
  resourceGroupDataLoaded: resourceGroupDataLoaded,
  resourceGroupChange: resourceGroupChange,
  toolkitToolClicked: toolkitToolClicked,
  toolkitToolActiveChanged: toolkitToolActiveChanged,
  fastbuyClose: fastbuyClose,
  fastbuyBuy: fastbuyBuy,
  fastbuySubmitPayment: fastbuySubmitPayment,
  fastbuyOrderFinish: fastbuyOrderFinish
};