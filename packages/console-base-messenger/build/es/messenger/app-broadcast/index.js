...
export default {
  ...
  toggleRegionGlobal: toggleRegionGlobal,
  setRegionId: setRegionId,
  setRegions: setRegions,
  setRegionGroups: setRegionGroups,
  setRegionResourceCount: setRegionResourceCount,
  toggleResourceGroup: toggleResourceGroup,
  setResourceGroupId: setResourceGroupId,
  setResourceGroupResourceCount: setResourceGroupResourceCount,
  setGoTopContainer: setGoTopContainer,
  putToolkitItem: putToolkitItem,
  removeToolkitItem: removeToolkitItem
};