...
export default {
  ...
  onRegionRefreshResourceCount: onRegionRefreshResourceCount,
  onResourceGroupDataLoaded: onResourceGroupDataLoaded,
  onResourceGroupChange: onResourceGroupChange,
  onToolkitItemClick: onToolkitItemClick,
  onToolkitVersionNewClick: onToolkitVersionNewClick,
  onToolkitVersionOldClick: onToolkitVersionOldClick,
  onToolkitItemActiveChange: onToolkitItemActiveChange,
  onFastbuyClose: onFastbuyClose,
  onFastbuyBuy: onFastbuyBuy,
  onFastbuySubmitPayment: onFastbuySubmitPayment,
  onFastbuyOrderFinish: onFastbuyOrderFinish
};