...
export default function VMfaBindInfo(): JSX.Element {
  ...
  const targetMfaDeviceSecret = _get(getBindMfaInfoData as IGetBindVMfaInfoData, 'TargetMfaDeviceSecret', '13141414afafafadafaf13141414afafafadafaf13141414afafafadafaf13141414afafafadafaf13141414afafafadafaf13141414afafafadafaf');
  const targetUserPrincipalName = _get(getBindMfaInfoData as IGetBindVMfaInfoData, 'TargetUserPrincipalName', '1234');
