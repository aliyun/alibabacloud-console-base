...
import { showBackdrop, removeBackdrop } from '../../rc/backdrop';
...
function trapFocus(domDialog, domDialogContent, how) {
  var el = getNextElementToFocus(domDialog, domDialogContent, how);
...
export default function pushStackAll(dialogId, item) {
...
export function focusDialog(domDialog, domDialogContent) {
