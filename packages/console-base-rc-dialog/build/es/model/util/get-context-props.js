...
export default function getContextProps(propps, propsUpdate) {
  ...
  finalProps.mode = (_finalProps$mode = finalProps.mode) !== null && _finalProps$mode !== void 0 ? _finalProps$mode : EDialogMode.NORMAL;
  ...
  finalProps.zIndex = (_finalProps$zIndex = finalProps.zIndex) !== null && _finalProps$zIndex !== void 0 ? _finalProps$zIndex : finalProps.mode === EDialogMode.SLIDE ? Z_INDEX.DIALOG_SLIDE : Z_INDEX.DIALOG_NORMAL;
  finalProps.zIndexBackdrop = (_finalProps$zIndexBac = finalProps.zIndexBackdrop) !== null && _finalProps$zIndexBac !== void 0 ? _finalProps$zIndexBac : finalProps.mode === EDialogMode.SLIDE ? Z_INDEX.BACKDROP_SLIDE : Z_INDEX.BACKDROP_NORMAL;
  return finalProps;
}