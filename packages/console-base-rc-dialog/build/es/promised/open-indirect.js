...
export default function openIndirect(contentOrProps) {
  var dialogProps = buildPropsForPromise(contentOrProps);
  ...
  function renderDialog(props) {
    render( /*#__PURE__*/React.createElement(DialogWithProvider, props), holder);
  }
