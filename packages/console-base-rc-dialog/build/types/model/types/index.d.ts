...
import { TDialogData, IDialogProps, IDialogPropsMutable, TFnCloseWithResult, TDispatchLock, TDispatchUpdateProps, TDispatchUpdateData } from '../../types';
...
export declare type TAction = {
    ...
    payload: IDialogPropsMutable<any, any>;
} | {
