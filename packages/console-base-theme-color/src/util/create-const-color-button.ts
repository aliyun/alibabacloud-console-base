...
export default function createConstColorButton(FG: IColorText, BG: IColorBg, BD: IColorBorder): IColorButton {
  return {
    ...
    BUTTON_TERTIARY_BG_DISABLED: BG.BG_TRANSPARENT,
