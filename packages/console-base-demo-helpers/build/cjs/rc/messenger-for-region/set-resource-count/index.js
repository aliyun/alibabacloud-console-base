...
function SetResourceCount() {
  var _useState = (0, _react.useState)(JSON.stringify(RESOURCE_COUNT)),
  ...
  var handleSet = (0, _react.useCallback)(function () {
    return _consoleBaseMessenger.forApp.setRegionResourceCount(JSON.parse(stateValue));
  }, [stateValue]);
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_demoRcElements.H3, null, "forApp.setRegionResourceCount(resourceCountMap)"), /*#__PURE__*/_react.default.createElement(_demoRcElements.P, null, "\u8BBE\u7F6E\u8D44\u6E90\u6570\uFF08\u81EA\u52A8\u5207\u6362\u4E3A\u300C\u975E\u5168\u7403\u300D\u6A21\u5F0F\uFF09"), /*#__PURE__*/_react.default.createElement(_demoRcElements.InputTextarea, {
