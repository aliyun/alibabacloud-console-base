...
exports.default = SetRegionGroups;
...
function SetRegionGroups() {
  var _useState = (0, _react.useState)(JSON.stringify(REGION_GROUPS)),
  ...
  var handleSet = (0, _react.useCallback)(function () {
    return _consoleBaseMessenger.forApp.setRegionGroups(JSON.parse(stateValue));
  }, [stateValue]);
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_demoRcElements.H3, null, "forApp.setRegionGroups(regions)"), /*#__PURE__*/_react.default.createElement(_demoRcElements.P, null, "\u8BBE\u7F6E\u53EF\u7528 region \u5206\u7EC4\u5217\u8868\uFF0C\u4F18\u5148\u7EA7\u9AD8\u4E8E regions\uFF08\u81EA\u52A8\u5207\u6362\u4E3A\u300C\u975E\u5168\u7403\u300D\u6A21\u5F0F\uFF09"), /*#__PURE__*/_react.default.createElement(_demoRcElements.InputTextarea, {
