...
To protect your account, set a verification method.`,
  ...
  'attr:vmfa_bind_code1': 'First Security Code',
  'attr:vmfa_bind_code2': 'Second Security Code',
  ...
  'message:u2f_get_key_cancel': 'The process of obtaining the U2F security key is terminated. Refresh the page and try again, or go back to the previous step.',
  ...
  'message:vmfa_bind_step1': '1. Scan the code to bind, or manually enter the key.',
  'message:vmfa_bind_step2': '2. Fill in two sets of security key.',
