...
var _getSystemParams = _interopRequireDefault(require("../util/get-system-params"));
...
function doLog(logUrl) {
  (0, _fetcherFetch.default)(logUrl, {
    timeout: 20000,
...
function createLogger(factoryOptions) {
  ...
  function sls(topic, params) {
    ...
    var logUrl = "".concat(BASE_LOG_URL, "?").concat(_qs.default.stringify(_objectSpread(_objectSpread(_objectSpread(_objectSpread({
      APIVersion: apiVersion,
      GROUP: options.group || 'LOG'
    }, (0, _getSystemParams.default)()), paramsDefault), params), {}, {
      __topic__: topic
    })));
