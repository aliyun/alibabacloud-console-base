export declare type TFnDefaultParams = () => Record<string, unknown>;
export declare type TDefaultParams = Record<string, unknown> | TFnDefaultParams;
export declare type TFnOnBeforeSend = (options: IFactoryOptions) => void | boolean;
...
export declare type TFnFactory = (options: IFactoryOptions) => IFnLog;
