...
exports.default = mixedBlackAndWhitelistChecker;
...
function mixedBlackAndWhitelistChecker(value, mixedList) {
  if (!(mixedList !== null && mixedList !== void 0 && mixedList.length)) {
    return true;
  }

  var _separateIntoBlackAnd = separateIntoBlackAndWhite(mixedList),
      _separateIntoBlackAnd2 = (0, _slicedToArray2.default)(_separateIntoBlackAnd, 2),
