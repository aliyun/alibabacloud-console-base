...
export default function buildUrl(url, _ref) {
  ...
  var finalParams = mergeParams([searchStr, urlCacheBusting ? {
    _cache_busting_: Date.now()
  } : undefined, params], serializeOptions);
  var finalQueryStr = serializeParams(finalParams, serializeOptions);
